...
const Hero = () => {
  return (
    <section id="home" className={`flex md:flex-row flex-col sm:py-[71px] py-6 sm:px-10`}>
      <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 ml-[5rem]`}>
        <h1 className='font-lato font-semibold ss:text-[34px] sm:pr-[13rem] text-[34px] mb-[20px] ss:leading-[54px] leading-[75px] w-full text-white'>Discover all possibilities of using this powerfull tool and create science figures, posters and infographics.</h1>
